...
;(function (x) {
	...
	if (typeof define === 'function' && define.amd) {
		...
		if(!x.fest)x.fest={};
		x.fest['ct-viewbox-slides.xml']=template;
	}
}(new Function('return this')()));
/* end: ./ct-viewbox-slides.tmp.fest.js */