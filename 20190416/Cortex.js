    ...
    (function (Components) {
        ...
        (function (Locales) {
            function Init(querySelector) {
                var urlLocale = $('body').attr('data-locale'), selector = querySelector, ctexLocales, visibility, gepLocales = 'en-us, en-ie, en-au, en-gb, es-mx, es-xl, de-de, en-ca, fr-ca, en-nz, sv-se, nb-no, pt-br, fi-fi, da-dk';
