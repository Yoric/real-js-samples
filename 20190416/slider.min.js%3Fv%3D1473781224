...
$(function(){$(".wrap_slick").css("visibility","visible").each(function(){var s=$(this).data("slider"),i=$(this).find(".slider-for-"+s).find("div").length;$(this).find(".slider-for-"+s).slick({slidesToShow:1,slidesToScroll:1,arrows:!1,fade:!0,asNavFor:".slider-nav-"+s}),$(this).find(".slider-nav-"+s).slick({slidesToShow:1,slidesToScroll:1,asNavFor:".slider-for-"+s,dots:!0,speed:1e3,autoplaySpeed:5e3,focusOnSelect:!0,autoplay:!0}),1==i&&$(this).find(".block-text").addClass("no-dots")})});