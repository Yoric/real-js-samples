window._JModuleRequireMap = {"dateFormart":[],"videoRecommend":[],"tabModule":["dateFormart"],"replenish":["getAreaInfo"],"renewRemind":[],"renderModule":[],"rankList":[],"price":["autoPartition","dmAreaStockState"],"outOfStockStyle":["addStyle"],"outOfStock":["outOfStockStyle"],"navigation":[],"hotSpot":[],"getYushouInfo":["price","countdown","autoQueue"],"getSkuCoupon":[],"getServerTime":[],"getSecurityJS":[],"getPromotionInfo":["price","autoQueue"],"getPingouInfo":["price","autoQueue"],"getPartitionInfo":[],"getGoodsInfo":["price","autoQueue","areaStockState","outOfStock"],"getCouponInfo":["autoQueue"],"getAreaInfo":[],"floating":["getServerTime"],"dmVideo":[],"dmTabModule":[],"dmSlide":[],"dmShopGoodsSearch":["price"],"dmShopCategory":[],"dmNavigation":[],"dmHotSpot":[],"dmGetGoodsInfo":["price"],"dmGetCouponState":[],"dmGetCoupon":[],"dmFloating":["getServerTime"],"dmCountdown":["getServerTime"],"dmCarousel":[],"dmAreaStockState":["getAreaInfo"],"dmAddFavorite":[],"countdown":["getServerTime"],"carousel":[],"autoQueue":[],"autoPartition":["getPartitionInfo"],"autoCenter":[],"attention":[],"areaStockState":["getAreaInfo"],"addStyle":[]};/******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
J_Module._throttle = function (module) {
    ...
    function realRequest() {
        var path = '//static.360buyimg.com/static-shop-sale-p/js/JModule/??';
...
$export($export.S, 'Math', { fround: __webpack_require__(346) });
