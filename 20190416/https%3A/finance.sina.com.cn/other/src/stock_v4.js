    ...
    setImg.method('showImage',function ()
        {
            ...
            alink.onmouseover = function (evt)
            {
                ...
                if(_type == "futures")
                {
                    ...
                    CHART += "TIME: " + _time;
                    CHART += "</div>";
                    CHART += "<div class=s6><a href=\"http://finance.sina.com.cn/money/future/quote.html?code=" + _code + "\" target='_blank'><img src=\"//image.sinajs.cn/newchart/v5/futures/min1/" + _code + ".gif\" width=\"199\" height=\"125\" border='0'></a></div>";
                    CHART += "<div class=\"s3\">";
                    CHART += "<ul>";
                    CHART += "</ul>";
                    CHART += "</div>";
