...
lib.ssMetadata = [
		{name:"O365SMB_TMSCOL_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_", frames: [[0,300,369,169],[0,471,329,181],[272,0,196,128],[0,0,270,298]]}
];
...
(lib._300x250_bg2 = function() {
	this.spriteSheet = ss["O365SMB_TMSCOL_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib._300x250_desk = function() {
	this.spriteSheet = ss["O365SMB_TMSCOL_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.ppl = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib._300x250_ppl();
	this.instance.parent = this;
	this.instance.setTransform(238,115,0.575,0.575);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ppl, new cjs.Rectangle(238,115,155.4,171.5), null);
...
(lib.laptop = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.instance = new lib._300x250_laptop();
	this.instance.parent = this;
	this.instance.setTransform(-31,126,0.55,0.55);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.laptop, new cjs.Rectangle(-31,126,107.8,70.4), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(129,66,0.575,0.575);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#2E2E26").s().p("AxpETIAAomMAjTAAAIAAImg");
	this.shape.setTransform(237,229.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(124,66,226,191.3), null);
...
(lib.desk = function(mode,startPosition,loop) {
	...
	// Layer_2
	this.instance = new lib._300x250_desk();
	this.instance.parent = this;
	this.instance.setTransform(26,64,0.556,0.556);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.desk, new cjs.Rectangle(26,64,182.8,100.6), null);
...
(lib.mainMC = function(mode,startPosition,loop) {
	...
	this.image_1.setTransform(68.5,241,0.9,0.9,0,0,0,68.5,209.1);

	this.timeline.addTween(cjs.Tween.get(this.image_1).wait(1));

	// white
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgZiAxeIAA+ZMAzFAAAIAAeZgA5im4MAAAgqlMAzFAAAMAAAAqlg");
	this.shape.setTransform(152.5,119.1);
	...
	this.image_2.setTransform(68.6,241,0.9,0.9,0,0,0,261.9,283.8);

	this.timeline.addTween(cjs.Tween.get(this.image_2).wait(1));

	// image desk
	this.image_3 = new lib.desk();
	this.image_3.name = "image_3";
	this.image_3.parent = this;
	this.image_3.setTransform(68.9,241.5,0.95,0.95,0,0,0,140.8,164.1);

	this.timeline.addTween(cjs.Tween.get(this.image_3).wait(1));

	// image bg
	this.image_4 = new lib.bg();
	this.image_4.name = "image_4";
	this.image_4.parent = this;
	this.image_4.setTransform(68.6,240.9,0.98,0.98,0,0,0,229.7,236.3);

	this.timeline.addTween(cjs.Tween.get(this.image_4).wait(1));

}).prototype = getMCSymbolPrototype(lib.mainMC, new cjs.Rectangle(-40.2,-197.4,356.2,633.2), null);


// stage content:
(lib.O365SMB_TMSCOL_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.runBanner = function() {
			...
			exportRoot.tl1.to(mc.image_1, 1.3, { scaleX:1, scaleY:1, x: "-=0", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
			...
			exportRoot.tl1.to(mc.image_4, 1.3, { scaleX:1, scaleY:1, x: "-=0", y: "+=0", ease:Power1.easeInOut}, "-=1.3")
...
p.nominalBounds = new cjs.Rectangle(39.8,277.6,356.2,633.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/O365SMB_TMSCOL_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_.png?1534833240670", id:"O365SMB_TMSCOL_USA_160x600_BAN_Teams_English_1250_NA_ANI_CH_T1_1_atlas_"}
	],
	preloads: []
};
