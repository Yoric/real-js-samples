...
(function () {
  ...
  ADventori.click = function (e, item, macros, opts) {
    ...
    if (clickTag && itemId != null) {
      clickTag = clickTag.replace('&URL=', ('&tk_retailer_1=' + encodeURIComponent(itemId)) + '&URL=');
    }
    ...
    var open = ADventori.open(ADventori.Macro.replace(clickTag + finalUrl, macros), opts);
