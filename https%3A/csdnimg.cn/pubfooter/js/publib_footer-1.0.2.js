;(function () {
  ...
  var bottom_public_footer = '<div class="bottom-pub-footer footer-box pub_fo"><div class="pub-footer-new">\
    ...
    <div id="pub-footerall">\
        ...
        <a href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202001032100010" target="_blank"><span>经营性网站备案信息</span></a>\
  ...
  function changeImg(){
    ...
    if(storage.getItem('randomN') === '0'){
      newItem += '<div class="img-box"><a href="https://blog.csdn.net/Blockchain_lemon?utm_source=csdn_footer" target="_blank"><img style="padding:0;" src="https://csdnimg.cn/pubfooter/images/csdn-qkl.png" alt="区块链大本营"></a><p class="app-text">区块链大本营</p></div>'
      storage.setItem("randomN", '1');
    }else if(storage.getItem('randomN') === '1'){
      newItem += '<div class="img-box" ><a href="https://www.csdn.net/app/?utm_source=csdn_footer" target="_blank"><img  src="https://csdnimg.cn/pubfooter/images/app.png" alt="下载CSDN APP"></a><p class="app-text">下载CSDN APP</p></div>'
      storage.setItem("randomN", '2');
    }else if(storage.getItem('randomN') === '2'){
      newItem += '<div class="img-box"><a href="https://blog.csdn.net/csdnnews?utm_source=csdn_footer" target="_blank"><img style="padding:0;" src="https://csdnimg.cn/pubfooter/images/csdn-zx.png" alt="官方公众号"></a><p class="app-text">官方公众号</p></div>'
      storage.setItem("randomN", '0');
    }
    newItem +='<div class="img-box"><a href="https://bbs.csdn.net/forums/Service?utm_source=csdn_footer" target="_blank"><img src="https://csdnimg.cn/pubfooter/images/csdn_cs_qr.png" alt="扫码联系微信客服"></a><p class="app-text">微信客服</p></div><div class="img-box last"><a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzgwMDE4MDEwNl80ODc3MzVfODAwMTgwMTA2XzJf" target="_blank"><img src="https://csdnimg.cn/pubfooter/images/csdn-kf.png" alt="扫码联系QQ客服"></a><p class="app-text">QQ客服</p></div>'
